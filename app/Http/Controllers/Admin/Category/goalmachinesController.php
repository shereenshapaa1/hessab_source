...
class goalmachinesController extends Controller
{
    private CategoryRepositoryInterface $categoryRepository;
    private $path = 'goalmachines';
    private $scope = 'MachineGoal';
    ...
    public function __construct(CategoryRepositoryInterface $categoryRepository)
    {
        ...
        $this->middleware('checkPermission:types.index')->only(['index']);
        $this->middleware('checkPermission:types.show')->only(['show']);
        $this->middleware('checkPermission:types.edit')->only(['edit']);
        $this->middleware('checkPermission:types.delete')->only(['destroy']);
        $this->middleware('checkPermission:types.create')->only(['create']);
    }
    ...
    {
        $data = $request->all();
        $data['type'] = Constants::MachineType;
