...
class EntityController extends Controller
{
    ...
    public function __construct(CategoryRepositoryInterface $categoryRepository)
    {
        ...
        $this->middleware('checkPermission:entities.index')->only(['index']);
        $this->middleware('checkPermission:entities.show')->only(['show']);
        $this->middleware('checkPermission:entities.edit')->only(['edit']);
        $this->middleware('checkPermission:entities.delete')->only(['destroy']);
        $this->middleware('checkPermission:entities.create')->only(['create']);
    }
    ...
    {
        $data = $request->all();
        $data['type'] = Constants::ApartmentEntity;
