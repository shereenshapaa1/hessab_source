...
class AboutController extends Controller
{
    ...
    public function __construct(ContentRepositoryInterface $contentRepository)
    {
        ...
        $this->middleware('checkPermission:about.index')->only(['index']);
        $this->middleware('checkPermission:about.show')->only(['show']);
        $this->middleware('checkPermission:about.edit')->only(['edit']);
        $this->middleware('checkPermission:about.delete')->only(['destroy']);
        $this->middleware('checkPermission:about.create')->only(['create']);
    }
