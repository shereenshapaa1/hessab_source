...
return [
    ...
    'email'                => 'من فضلك قم بإدخال بريد إلكتروني صحيح',
    ...
    */
    ...
    'attributes' => [
        ...
        'name' => 'الاسم بالكامل',
        'address' => 'عنوان طالب التقييم',
        'real_estate_area' => 'المساحة (م2)',
        'type_id' => 'نوع العقار محل التقييم',
        'usage_id' => 'استعمال العقار',
        'real_estate_age' => 'العمر (سنوات)',
        'ApartmentDetail' => 'بيانات العقار',
        'notes' =>'تفاصيل العقار',
        'entity_id' =>'الجهه الموجه اليها التقييم',

        'other_contracts' => 'عقود اخرى',
        'construction_license' => 'رخصه البناء',
        'instrument_image' => 'صورة الصك',
        'goal_id' =>'الغرض من طلب التقييم'
    ],
