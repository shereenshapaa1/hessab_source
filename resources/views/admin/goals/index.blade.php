            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">@lang('admin.Goals') <span
                        ...
                        @if (can('goals.create'))
                            <a class="btn btn-success pull-right text-white" href="{{ route('admin.goals.create') }}">
                                <i class=" icon-plus"></i>
                        @endif
                                            ...
                                            <td class="text-left">
                                                @if (can('goals.edit'))
                                                    ...
                                                    <a class="btn btn-sm btn-warning"
                                                        href="{{ route('admin.goals.edit', $item->id) }}">
                                                        <i class="text-white icon-note"></i>
                                                    </a>
                                                @endif
                                                @if (can('goals.destroy'))

                                                    <form action="{{ route('admin.goals.destroy', $item->id) }}"
