...
@section('tab_name', __('admin.reliability'))
@section('css')
...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-name">@lang('admin.reliability') /
                        @if ($item->id)
                    ...
                    <hr>
                    @if ($item->id)
                        <form class="needs-validation" action="{{ route('admin.reliability.update', $item->id) }}"
                            method="POST" enctype='multipart/form-data' novalidate>
                            <input type="hidden" name="_method" value="PUT">
                        @else
                            <form class="needs-validation" action="{{ route('admin.reliability.store') }}" method="POST"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group ">
                                      ...
                                      <input multiple  type="file" name="image[]" accept="image/png, image/jpeg, image/jpg"
                                            data-default-file="{{ old('image', $item->image) }}" class=""
                                            id="image-field">
<table>
...
<tr>
        <td>
        <img style="height: 50px;width:50px" src="{{asset($image)}}" alt="">
