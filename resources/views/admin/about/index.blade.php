...
@section('content')
    <div class="row">
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">@lang('admin.About') <span
                            class="badge badge-danger">{{ $result['counts'] ?? '0' }}</span>
                        @if (can('about.create'))
                            <a class="btn btn-success pull-right text-white" href="{{ route('admin.about.create') }}">
                                <i class=" icon-plus"></i>
                            </a>
                        @endif
                    </h4>
                                            ...
                                            <td class="text-left">
                                                @if (can('about.edit'))
                                                    ...
                                                    <a class="btn btn-sm btn-warning"
                                                        href="{{ route('admin.about.edit', $item->id) }}">
