            ...
            <div id="dvContainer" class="card-body">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <input type="text" disabled  value="{{$price->price_tax}}" name="price_tax" id="price_tax">
                                            ...
                                            @else
                                            <input type="text" disabled  value="" name="price_tax" id="price_tax">
                ...
                <div class="container-fluid w-100">
                   <!-- <a type="button"  onclick="print1()" id="btnPrint" class="btn btn-primary float-right mt-4 ms-2"><i
                    ...
                    <button type="submit" formaction="" action="{{url('admin/addprice')}}" class="btn btn-success float-right mt-4"><i class="ti-export me-1"></i>حفظ</button>
                    <button type="button" onClick="print1()" class="btn btn-primary float-right mt-4 ms-2"><i
      ...
      function print1() {
          ...
          var value=  $('#discount').val();
              ...
              if(value==''){
               ...
               document.getElementByClass('not_print').classList.add('no-print');
                };
              }
              window.print(); 
