                ...
                <div class="card-body">
                    <div class="container-fluid">
                        <h3 class="text-right my-5">@lang('admin.RatesNo')&nbsp;&nbsp;#RR-{{ $item->id }}
                            <a href="{{url('admin/rates/peaper/'.$item->id.'')}}" class="btn btn-primary float-left"></i>تحديد الأوراق المطلوبة</a> 
                        </h3>
...
">@lang('admin.appointment') :
                ...
                <p>
                    <a class="text-dark " href="{{url('admin/rates/showprice/'.$price->id.'/')}}">  عرض السعر  </a>
                 </p>
